...
<body>
<z:window style="padding:5px" apply="projectx.register.EditComposer">
    <z:longbox name="id" value="${registerInstance.id}" visible="false"/>
    <z:longbox name="version" value="${registerInstance.version}" visible="false"/>
