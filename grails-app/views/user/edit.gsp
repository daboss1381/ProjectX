...
<body>
<z:window style="padding:5px" apply="projectx.user.EditComposer">
    <z:longbox name="id" value="${userInstance.id}" visible="false"/>
    <z:longbox name="version" value="${userInstance.version}" visible="false"/>
